...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CrossChain processing");
    
    let mut processor = CrossChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CrossChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CrossChainProcessor::new(false);
